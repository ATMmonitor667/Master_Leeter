...
export default function PrivacyPage() {
  return <main className="policy-shell">
    ...
    <section><h2>Beta support</h2><p>The live interview can send a consented diagnostic report containing only closed status fields and opaque references. It excludes code, notes, transcripts, audio, device names and free text. Use the <a href="/support">support page</a> and contact the person who invited you for privacy requests or unresolved deletion receipts.</p></section>
  </main>;
}
